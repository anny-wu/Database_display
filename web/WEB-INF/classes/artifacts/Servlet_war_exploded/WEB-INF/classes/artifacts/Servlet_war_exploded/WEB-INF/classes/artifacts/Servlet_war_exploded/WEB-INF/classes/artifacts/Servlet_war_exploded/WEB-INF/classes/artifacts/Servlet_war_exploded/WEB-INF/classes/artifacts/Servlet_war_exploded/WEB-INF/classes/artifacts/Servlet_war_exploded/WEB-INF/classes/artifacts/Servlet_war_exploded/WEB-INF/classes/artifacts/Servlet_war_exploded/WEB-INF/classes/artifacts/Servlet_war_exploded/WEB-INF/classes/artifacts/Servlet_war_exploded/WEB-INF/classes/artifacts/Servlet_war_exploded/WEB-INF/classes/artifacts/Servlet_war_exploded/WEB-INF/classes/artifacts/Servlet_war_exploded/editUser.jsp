                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-6">
                            <div class="form-outline">
                                ...
                                %>
                                <input hidden id="hiddenID" value="<%=.getid()%>"/>
                                <input hidden id="hiddenName" value="<%=u.getusername()%>"/>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        $('#selectS').change(function () {
            ...
            $('#id').attr('placeholder',$("#hiddenID").val());
            $('#username').attr('placeholder',$("#hiddenName").val());
        });
    });
</script>
</html>
