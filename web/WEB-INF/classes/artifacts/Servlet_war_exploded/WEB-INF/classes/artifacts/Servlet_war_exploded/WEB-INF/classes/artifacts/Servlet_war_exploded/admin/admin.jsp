        ...
        <div id="controls">
            ...
            <nav class="m-auto">
                <ul class="pagination justify-content-center">
                    ...
                    <%}else{%>
                    <li class="page-item">
                        <a class="page-link" href="EditUserByPage?currentPage=<%=currP-1%>&pageSize=${pageS}"
                    ...
                    <li class="page-item">
                        <% } %>
                        <a class="page-link"
                           href="EditUserByPage?currentPage=<%=i%>&pageSize=${pageS}"><%=i%></a></li>
                    <%}%>
                    ...
                    <%}else{%>
                    <li class="page-item">
                        <a class="page-link" href="EditUserByPage?currentPage=<%=currP+1%>&pageSize=${pageS}">&raquo;</a>
                    </li>
                    <%}%>
