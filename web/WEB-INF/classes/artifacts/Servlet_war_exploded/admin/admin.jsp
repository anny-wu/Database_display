...
<div class="row">
    <div class="col-8 m-auto">
        <div id="controls">
            ...
            <div>
                <form id="display" class="display d-flex justify-content-between" method="post">
                    <div>
                        ...
                        <button id="add" type="submit" formaction="../addUser.jsp" class="btn controls">
                            <svg xmlns="http://www.w3.org/2000/svg" class="bi bi-plus-square-fill iconS" viewBox="0 0 16 16">
            ...
            <nav class="m-auto">
                <ul class="pagination justify-content-center">
                    ...
                    <%}else{%>
                        <li class="page-item">
                            <a class="page-link" href="EditUserByPage?currentPage=<%=currP-1%>&pageS=${pageS}" aria-disabled="true"><span aria-hidden="true">&laquo;</span></a>
                        </li>
                    <%}
                    ...
                    <%  }else{ %>
                            <li class="page-item">
                    <%  } %>
                                <a class="page-link" href="EditUserByPage?currentPage=<%=i%>&pageS=${pageS}"><%=i%></a></li>
                    ...
                    <%}else{%>
                    <li class="page-item">
                        <a class="page-link" href="EditUserByPage?currentPage=<%=currP+1%>&pageS=${pageS}">&raquo;</a>
                    </li>
                    <%}%>
                </ul>
            </nav>
